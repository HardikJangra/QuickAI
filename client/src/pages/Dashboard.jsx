...
const Dashboard = () => {
  ...
  const getDashboardData = async ()=>{
    try{
      setLoading (true)
      const {data} = await axios.get('/api/creations/user-creations',{
        headers: {
    ...
    <div className='h-full overflow-y-scroll p-6'>
      <div className='flex justify-start gap-4 flex-wrap'>
        ...
        rounded-xl border border-gray-200'>
          ...
          <div className='w-10 h-10 rounded-1g bg-gradient-to-br from-[#3588F2]
        ...
        rounded-xl border border-gray-200'>
          ...
          <div className='w-10 h-10 rounded-1g bg-gradient-to-br from-[#FF61C5]
